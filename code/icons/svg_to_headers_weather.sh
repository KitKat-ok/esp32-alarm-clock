...
SVG_FILES="./svg_weather/*.svg"
PNG_PATH="./png/weather_${1}x${1}"
PNG_FILES="${PNG_PATH}/*.png"
HEADER_PATH="./icons/weather_${1}x${1}"
HEADER="./icons/weather_icons_${1}x${1}.h"
...
do
    echo "#include \"weather_${1}x${1}/$(basename $f)\"" >> $HEADER
done
echo "#endif" >> $HEADER
